...
export const hbApi = {
  ...
  collections: {
    list: () =>
      api.get<ApiResponse<CollectionModel[]>>('/_/collections'),
    get: (name: string) =>
      api.get<ApiResponse<CollectionModel>>(`/_/collections/${name}`),
  ...
  records: {
    ...
    get: (collectionName: string, id: string, params?: { expand?: string }) =>
      api.get<ApiResponse<RecordModel>>(`/api/collections/${collectionName}/records/${id}`, { params }),
    ...
    delete: (collectionName: string, id: string) =>
      api.delete<ApiResponse<{ success: boolean }>>(`/api/collections/${collectionName}/records/${id}`),
  },
  ...
  system: {
    getOpenApiSpec: () =>
      api.get<Record<string, unknown>>('/api-doc/openapi.json'),
    ...
    getSettings: () =>
      api.get<ApiResponse<Record<string, unknown>>>('/api/admin/settings'),
