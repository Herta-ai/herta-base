...
function WebProjectsPage() {
  ...
  const rollbackMutation = useMutation({
    ...
    onSuccess: (_, variables) => {
      setSuccessMessage(
        t('web.rollback_success', { name: variables.project.name, version: variables.version }),
      );
    ...
    └── assets/`}
            ...
            >
              ...
              {selectedFile ? (
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div>
                    <span
                      style={{ fontSize: 12, fontWeight: 600, color: 'var(--jb-text-heading)' }}
                    >
        ...
        >
          ...
          >
            ...
            {/* Search Filter */}
            <div
              style={{ width: 200, position: 'relative', display: 'flex', alignItems: 'center' }}
            >
          ...
          <div style={{ overflowX: 'auto' }}>
            {isLoading ? (
              ...
              >
                <Loader />
                <span style={{ color: 'var(--jb-text-muted)', fontSize: 13 }}>
                  {t('app.loading')}
                </span>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '12px 16px', verticalAlign: 'middle' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            <span className="i-ph:globe-hemisphere-east-bold text-sky-400 text-16px shrink-0" />
                            <div>
                              <div
                                style={{
                                  fontWeight: 700,
                              ...
                              >
                                <span
                                  style={{
                                    ...
                                    padding: '1px 6px',
                                    borderRadius: 3,
                                    background: project.spaFallback
                                      ? 'rgba(53, 116, 240, 0.12)'
                                      : 'var(--jb-header-bg)',
                                    color: project.spaFallback
                                      ? 'var(--jb-accent-blue)'
                                      : 'var(--jb-text-muted)',
                                    border: '1px solid var(--jb-border)',
                                    fontWeight: 500,
                            ...
                            >
                              ...
                              >
                                <span
                                  className={
                                    copiedUrlProject === project.name
                                      ? 'i-ph:check-bold text-12px'
                                      : 'i-ph:copy-bold text-12px'
                                  }
                                />
                              </button>
                            </Tooltip>
                        ...
                        >
                          {project.deployedAt
                            ? dayjs(project.deployedAt).format('YYYY-MM-DD HH:mm:ss')
                            : '-'}
                        </td>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span className="i-ph:clock-counter-clockwise-bold text-11px text-purple-400" />
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 4 }}>
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        applyCachePreset('public, max-age=3600, must-revalidate', true)
                      }
                      style={{
                        background: 'var(--jb-header-bg)',
                        border: '1px solid var(--jb-border)',
          ...
          >
            ...
            >
              {versionsLoading ? (
                ...
                >
                  <Loader />
                  <span style={{ color: 'var(--jb-text-muted)', fontSize: 12 }}>
                    {t('app.loading')}
                  </span>
                </div>
                ...
                (versionsMap[versionsModalProject.name] || []).map((version) => {
                  ...
                  return (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <span className="i-ph:archive-box-bold text-purple-400 text-16px shrink-0" />
                        <div>
                          <div
                            style={{
                              fontWeight: 600,
